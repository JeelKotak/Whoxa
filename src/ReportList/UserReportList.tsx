...
const users = [
  { orderId: "#1", reportedName: "Manuel Langworth", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Manuel", reporterName: "Sarah Jenkins", reporterID: "901", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah", name: "Manuel Langworth", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Manuel", reportCount: 12, createdDate: "Nov 3, 2022", status: true, reportType: "Scam or Fraud", reportText: "Unknown" },
  { orderId: "#2", reportedName: "Sherry Weber", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sherry", reporterName: "Kevin Temple", reporterID: "902", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Kevin", name: "Sherry Weber", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sherry", reportCount: 5, createdDate: "Oct 3, 2022", status: true, reportType: "Harassment", reportText: "Unknown" },
  { orderId: "#3", reportedName: "Kelli Mitchell", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Kelli", reporterName: "John Doe", reporterID: "903", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=John", name: "Kelli Mitchell", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Kelli", reportCount: 22, createdDate: "Nov 30, 2022", status: false, reportType: "Spam", reportText: "Unknown" },
  { orderId: "#4", reportedName: "Mattie Miller", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Mattie", reporterName: "Emma Wilson", reporterID: "904", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Emma", name: "Mattie Miller", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Mattie", reportCount: 2, createdDate: "Sep 17, 2022", status: true, reportType: "Inappropriate Content", reportText: "Unknown" },
  { orderId: "#5", reportedName: "Ricardo Kling", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ricardo", reporterName: "Liam Neeson", reporterID: "905", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Liam", name: "Ricardo Kling", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ricardo", reportCount: 18, createdDate: "Dec 4, 2022", status: true, reportType: "Hate Speech", reportText: "Unknown" },
  { orderId: "#6", reportedName: "Jill Russel", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jill", reporterName: "Olivia Wilde", reporterID: "906", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Olivia", name: "Jill Russel", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Jill", reportCount: 31, createdDate: "July 13, 2023", status: true, reportType: "Fake Profile", reportText: "Unknown" },
  { orderId: "#7", reportedName: "Shelley Lind", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Shelley", reporterName: "Noah Centineo", reporterID: "907", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Noah", name: "Shelley Lind-VonRueden", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Shelley", reportCount: 7, createdDate: "Feb 28, 2023", status: true, reportType: "Scam or Fraud", reportText: "Unknown" },
  { orderId: "#8", reportedName: "Connie Braun", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Connie", reporterName: "Ava Max", reporterID: "908", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ava", name: "Connie Braun", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Connie", reportCount: 9, createdDate: "July 3, 2023", status: false, reportType: "Harassment", reportText: "Unknown" },
  { orderId: "#9", reportedName: "Byron Hoppe", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Byron", reporterName: "Sophia Loren", reporterID: "909", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sophia", name: "Byron Hoppe III", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Byron", reportCount: 1, createdDate: "Nov 30, 2022", status: true, reportType: "Spam", reportText: "Unknown" },
  { orderId: "#10", reportedName: "Genevieve Hammes", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Genevieve", reporterName: "Lucas Hedges", reporterID: "910", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lucas", name: "Genevieve Hammes", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Genevieve", reportCount: 14, createdDate: "Jan 25, 2023", status: true, reportType: "Inappropriate Content", reportText: "Unknown" },
  { orderId: "#11", reportedName: "Damon Friesen", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Damon", reporterName: "Mia Goth", reporterID: "911", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Mia", name: "Damon Friesen", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Damon", reportCount: 4, createdDate: "Mar 12, 2023", status: true, reportType: "Hate Speech", reportText: "Unknown" },
  { orderId: "#12", reportedName: "Lucille Schowalter", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lucille", reporterName: "Ethan Hawke", reporterID: "912", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ethan", name: "Lucille Schowalter", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lucille", reportCount: 20, createdDate: "Jan 15, 2023", status: true, reportType: "Fake Profile", reportText: "Unknown" },
  { orderId: "#13", reportedName: "Reginald Klocko", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Reginald", reporterName: "Isabella Rossellini", reporterID: "913", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Isabella", name: "Reginald Klocko", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Reginald", reportCount: 3, createdDate: "June 22, 2023", status: true, reportType: "Scam or Fraud", reportText: "Unknown" },
  { orderId: "#14", reportedName: "Margarita Kunze", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Margarita", reporterName: "Oscar Isaac", reporterID: "914", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Oscar", name: "Margarita Kunze", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Margarita", reportCount: 50, createdDate: "May 5, 2023", status: false, reportType: "Harassment", reportText: "Unknown" },
  { orderId: "#15", reportedName: "Ignacio Predovic", reportedAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ignacio", reporterName: "Penelope Cruz", reporterID: "915", reporterAvatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Penelope", name: "Ignacio Predovic", type: "user", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Ignacio", reportCount: 6, createdDate: "Aug 30, 2023", status: true, reportType: "Spam", reportText: "Unknown" },
];
    ...
    <div className="w-full bg-white text-[#111827] theme-container">
      <div className="px-2 pt-4 pb-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold">User Report List</h1>
            <nav className="flex items-center gap-2 text-sm text-black font-medium mt-1">
              ...
              <span className="w-1 h-1 bg-gray-300 rounded-full" />
              <span className="text-gray-500 cursor-default">User Report List</span>
            </nav>
          </div>
            ...
            <table className="w-full min-w-[1000px] text-left">
              <thead className="bg-[#f1f1f1] text-gray-500 border-b border-[#e3e3e3]">
                <tr className="text-xs font-semibold uppercase whitespace-nowrap">
                  <th className="px-4 py-4">Reported User ID</th>
